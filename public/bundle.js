...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			attr(div, "id", "map");
    			add_location(div, file, 71, 0, 1809);
    		},
    ...
    function create_fragment$2(ctx) {
    	var div12, div11, div2, div0, t1, div1, t2, div8, div3, span0, input0, label0, t4, div4, span1, input1, label1, t6, div5, span2, input2, label2, t8, div6, span3, input3, label3, t10, div7, span4, input4, label4, t12, div10, label5, t13, input5, t14, div9, div12_class_value, div12_intro, div12_outro, current;
    ...
    console.log('sss 7777777 ssssss', value);
    	...
    	let setZoom = ((ev) => {
    		let z = leafletMap.getZoom();
    		zoom.textContent = z;		console.log('setZoom', leafletMap.getZoom(), ev);
    	});
    	// let leafletMap = getContext('leafletMap');
    	// console.log('leafletMap', zoom, leafletMap);
    	L.Map.addInitHook(function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file$3, 37, 5, 811);
    			attr(div1, "class", "logo_left_text");
    			add_location(div1, file$3, 40, 5, 864);
    			attr(span0, "class", "logo");
    			add_location(span0, file$3, 36, 2, 786);
    			attr(div2, "class", "icons-header-left1");
    			add_location(div2, file$3, 46, 5, 992);
    			attr(div3, "class", "icons-header-left2");
    			add_location(div3, file$3, 47, 5, 1036);
    			attr(div4, "class", "left-icons-left");
    			add_location(div4, file$3, 45, 5, 957);
    			attr(div5, "class", "icons-header-right1");
    			add_location(div5, file$3, 50, 5, 1128);
    			attr(div6, "class", "icons-header-right2");
    			add_location(div6, file$3, 51, 5, 1173);
    			attr(div7, "class", "left-icons-right");
    			add_location(div7, file$3, 49, 5, 1092);
    			attr(div8, "class", "left-icons");
    			add_location(div8, file$3, 44, 2, 927);
    			attr(div9, "class", "left-icons-1-act");
    			add_location(div9, file$3, 54, 2, 1236);
    			attr(input0, "class", "range-slider__range");
    			attr(input0, "type", "range");
    			input0.value = "30";
    			attr(input0, "min", "0");
    			attr(input0, "max", "100");
    			add_location(input0, file$3, 57, 5, 1343);
    			attr(span1, "class", "range-slider__value");
    			add_location(span1, file$3, 58, 5, 1426);
    			attr(span2, "class", "percent");
    			add_location(span2, file$3, 59, 5, 1475);
    			attr(div10, "class", "range-slider");
    			add_location(div10, file$3, 56, 5, 1311);
    			attr(div11, "class", "slider-container");
    			add_location(div11, file$3, 55, 2, 1275);
    			attr(div12, "class", "block_left");
    			add_location(div12, file$3, 35, 2, 759);
    			attr(input1, "type", "text");
    			attr(input1, "name", "input");
    			attr(input1, "placeholder", "Поиск по адресам и координатам");
    			attr(input1, "class", "header-input");
    			add_location(input1, file$3, 64, 2, 1566);
    			attr(div13, "class", "account");
    			add_location(div13, file$3, 65, 2, 1667);
    			attr(div14, "class", "block_right");
    			add_location(div14, file$3, 63, 2, 1538);
    			attr(div15, "class", "header");
    			add_location(div15, file$3, 34, 2, 736);
    			attr(div16, "class", "icons-vert-top-1");
    			add_location(div16, file$3, 70, 3, 1803);
    			attr(div17, "class", "icons-vert-top-2");
    			add_location(div17, file$3, 71, 3, 1843);
    			attr(div18, "class", "icons-vert-top-3");
    			add_location(div18, file$3, 72, 3, 1883);
    			attr(div19, "class", "icons-vert-top");
    			add_location(div19, file$3, 69, 3, 1771);
    			attr(div20, "class", "icons-vert-bottom-1");
    			add_location(div20, file$3, 75, 3, 1968);
    			attr(div21, "class", "icons-vert-bottom");
    			add_location(div21, file$3, 74, 3, 1933);
    			attr(div22, "class", "sidebar");
    			add_location(div22, file$3, 68, 3, 1746);
    			attr(div23, "class", "right-controls-2");
    			add_location(div23, file$3, 81, 2, 2101);
    			attr(div24, "class", "right-controls");
    			add_location(div24, file$3, 80, 1, 2070);
    			attr(div25, "class", "copyright");
    			add_location(div25, file$3, 87, 2, 2199);
    			attr(div26, "class", "copyright-bottom");
    			add_location(div26, file$3, 88, 2, 2231);
